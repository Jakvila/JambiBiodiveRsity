...
setwd("C:/Users/jakob/biodiversity_data/Biodiversitas/3")
...
setwd("C:/Users/jakob/biodiversity_data/Biodiversitas/12")
...
# but document name wasn't changed
  ...
  setwd(file.path("C:/Users/jakob/biodiversity_data/Biodiversitas/3")) 
...
# rbind loop 
  ...
  setwd(file.path("C:/Users/jakob/biodiversity_data/Biodiversitas/",i ))
  ...
  for (j in 1:46310){
    ...
    if(is.na(x$X2[j])==TRUE && is.na(x$X3[j])==FALSE){
      x$X2[j] <- x$X3[j]
  }
}
